...
alias r='ranger'
alias n='nano'
alias server-upgrade="sudo apt update && sudo apt upgrade"
...
alias webserver="sudo systemctl start httpd.service && sudo systemctl start mariadb.service"
alias db="sudo systemctl start mariadb.service"
alias vi="vim"
alias bat="wine cmd.exe /c "
alias mnl="WINEARCH=win32 WINEPREFIX=/home/reza/.wine32 wine Game.exe"
alias pa="php artisan"
alias ra="sudo systemctl restart httpd.service"
alias rmysql="sudo systemctl restart mariadb.service"
alias gr="go run"
